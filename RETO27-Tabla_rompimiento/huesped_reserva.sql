...
insert into reservas values ('11/05/2023','12/05/2023',4,3);
							('11/05/2023','12/05/2023',2,10),
...
--1
select hb.habitacion_numero as numero_habitacion ,hp.nombre as nombre ,hp.apellido as apellido 
from habitaciones hb,huespedes hp ,reservas rs
--estrablecer relacion de claves 
where hb.habitacion_numero=rs.habitacion
and hp.id=rs.huesped_id	
...
--3
select hb.habitacion_numero as numero_habitacion, count (rs.huesped_id) as cantidad 
from habitaciones hb ,reservas rs	
where hb.habitacion_numero=rs.habitacion
 group by hb.habitacion_numero;
--4
select hb.habitacion_numero as numero_habitacion,hb.piso ,hp.nombre ,hp.apellido
from habitaciones hb,huespedes hp ,reservas rs
--estrablecer relacion de claves 
where id in(select hb.habitacion_numero from habitaciones where hb.piso=4)
and hb.habitacion_numero=rs.habitacion
and hp.id=rs.huesped_id	
...
--6
select hb.habitacion_numero, avg (rs.huesped_id)as pro_hues
from habitaciones hb ,reservas rs	
where hb.habitacion_numero=rs.habitacion
 group by hb.habitacion_numero;
 --7

 select hb.habitacion_numero  ,hp.nombre  ,hp.apellido 
from habitaciones hb,huespedes hp ,reservas rs
--estrablecer relacion de claves 
where hb.habitacion_numero=rs.habitacion
and hp.id=rs.huesped_id	
...
--9
select hb.habitacion_numero, sum (hb.precio_por_noche)
from habitaciones hb ,reservas rs	
where hb.habitacion_numero=rs.habitacion
 group by hb.habitacion_numero;
